...
def topups():
    ...
    html = "<h2>Top-up Requests</h2><table border=1>"
    html += "<tr><th>ID</th><th>User</th><th>Amount</th><th>Status</th><th>Action</th></tr>"
...
def products():
    ...
    html = "<h2>Services</h2><table border=1>"
